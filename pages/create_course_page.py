...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.preview_image_upload_icon_title = page.get_by_test_id(
    ...
    def check_visible_image_upload_view(self, is_image_uploaded: bool = False):
        ...
        expect(self.preview_image_upload_icon_title).to_be_visible()
        expect(self.preview_image_upload_icon_title).to_have_text('Tap on "Upload image" button to select file')
