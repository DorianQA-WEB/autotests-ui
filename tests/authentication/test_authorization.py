...
class TestAuthorization:
    ...
    def test_successful_authorization(
        ...
        registration_page.registration_form.fill(email='user@example.com', username='username', password='password')
        ...
        login_page.login_form.fill(email='user@example.com', password='password')
